...
- Alessandra Volta creates first battery based on his understanding of why the frog's leg twitched when touch with dissimilar metals.
...
- Michael Faraday creates first electric current generator by building a device that moves a conductor through a magnetic field.
